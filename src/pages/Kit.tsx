...
const columns = [
  ...
  },
  {
    ...
    body: 'Event materials — flyers, banners, extra NFC keychains — request through the Assets channel in the private Telegram group after approval. DSC Membership Cards come as an allotment to give out as you see fit, only to people who will actually push the movement forward. Be mindful.',
  },
  {
    label: 'Comms',
  ...
  return (
    <div>
      <PageHero
        ...
        lede="Wearables for events, tools for onboarding, and a private line into the club. Nothing here is a gimmick — every piece has a job."
      />
        ...
        <div className="mt-8 grid items-center gap-10 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-cream-3">
              ...
              discretion — only to people who will actually push the movement forward. Black and
              cream, numbered, unmistakably not a loyalty punch card.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-6 py-20 text-center md:py-28">
        <HairlineCard className="text-left md:text-center">
          ...
          <p className="mt-3 text-sm leading-relaxed text-cream-3 md:mx-auto md:max-w-md">
            Extra event assets — flyers, banners, more keychains and cards — are requested directly
